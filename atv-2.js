document.querySelector("#atv-2").addEventListener("click", atividade2)
...
/**
 * @callback  HandleShow
 * @param {Object.<(string|number), any>} values
 * @returns {void}
*/

/**
 * @param {SubmitEvent} event
 * @param {(salario: number) => number} calcularTaxaDeDesconto
 * @param {HandleShow} handleShow
*/
